CREATE DATABASE  IF NOT EXISTS `db_veterinaria` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_veterinaria`;
-- MySQL dump 10.13  Distrib 8.0.27, for Win64 (x86_64)
--
-- Host: localhost    Database: db_veterinaria
-- ------------------------------------------------------
...
CREATE TABLE `historical` (
  ...
  CONSTRAINT `fk_historical_customer1` FOREIGN KEY (`customer_idCustomer`) REFERENCES `customer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-06-28  0:41:33
